// The first semi-specific to node piece
// We'll need jquery to track events
// Later we'll want to clean this up to be more atomic
var $ = require('jquery')
...
var IPython = (function (IPython) {
    ...
    var Kernel = function (kernel_service_url) {
        ...
        // If we want the ability to toggle Widgets later, we'll have to bring
        // this back in. For now, this is a blocker on kernel functionality
...
// Everything else was client side. Time to export this for node
// Used http://nodejs.org/api/modules.html#modules_modules
